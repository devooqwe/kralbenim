...
client.on('message', msg => {
  ...
  if (msg.content.toLowerCase() === prefix + 'ping') {
    ...
    if (msg.content.toLowerCase() === prefix + 'nsfw-gif') {
    msg.reply('NSFW Komutu 1 gün boyunca kapalıdır. 19.11.2018 Mevlit Kandili Sebebiyle.. Hayırlı Kandiller')
  }
    if (msg.content.toLowerCase() === prefix + 'nsfw-hd') {
    msg.reply('NSFW Komutu 1 gün boyunca kapalıdır. 19.11.2018 Mevlit Kandili Sebebiyle.. Hayırlı Kandiller')
  }
